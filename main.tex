...
\author{Alexander~C.~Whitehead,~\IEEEmembership{Student~Member,~IEEE,}
    ...
    \thanks{Alexander~C.~Whitehead, Ander~Biguri, Brian~F.~Hutton and Kris~Thielemans are with the Institute of Nuclear Medicine, University College London, London, NW1~2BU, UK (contact: \texttt{alexander.whitehead.18@ucl.ac.uk}).}%
    ...
    \thanks{Scott~Wollenweber and Charles~Stearns are with Molecular Imaging and Computed Tomography Engineering, GE Healthcare, USA}%
